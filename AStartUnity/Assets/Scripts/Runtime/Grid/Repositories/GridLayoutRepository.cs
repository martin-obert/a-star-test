...
namespace Runtime.Services
{
    public sealed class GridLayoutRepository : IGridLayoutRepository
    {
        ...
        public  async Task<GridCellDataModel[]> LoadAsync(string filename, ITerrainVariant[] terrainVariants,
            CancellationToken token = default)
        {
            ...
            var data = JsonConvert.DeserializeObject<GridCellDataModel[]>(json);
